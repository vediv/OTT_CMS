...
var track_load = 1; //total loaded record group(s)
	 ...
	 $('#result_thumbnail').load("liveThumbnail.php",
	...
	$("#uploadForm").on('submit',(function(e) { 
		...
		$.ajax({
			...
			success: function(data)
			     ...
			     {
			     	   var enteryidd = "<?php echo $Entryid; ?>";
			     	   $('#result_thumbnail').load("liveThumbnail.php",{'entryid':enteryidd}); //load first group
                                   $("#upload_loader").hide(); 
...
function save_thumbnail(thumb,entryid,pageindex,limitval){
    ...
    var dataString ='maction='+thumb+'&entryid='+entryid+'&first_load='+pageindex+'&limitval='+ limitval;
    $.ajax({
           type: "POST",
