      ...
      <div id="suggestions-container" style="position: relative; float: left; width: 200px;"></div>
         ...
         <div class="form-group">
            ...
            <div class="col-xs-8" style="padding-right: 20px">
             <input id="country_code" type="text" class="form-control"  name="country_code" value="<?php echo $countrycode; ?>"  placeholder="Enter Country Code" />
...
//src:"http://ott01.planetcast.co.in/p/101/sp/10100/playManifest/entryId/0_6twye5yz/format/applehttp/protocol/http/a.m3u8"
//http://ott01.planetcast.co.in/p/101/sp/10100/raw/entry_id/0_6twye5yz/format/applehttp/protocol/http/a.m3u8
src:resDataUrl
...
function save_metedata_live_in_server(livematadata,entryid,pageindex){
    ...
    $.ajax({
                url:'http://api.planetcast.in:6080/livefeed',
                method: 'POST',
                dataType: 'json', 
                data:apiBody,
                processData: false,
