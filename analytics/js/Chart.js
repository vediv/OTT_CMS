...
console.log("\\",context.canvas['offsetWidth'] ,"--", this.width ,"--", document.defaultView.getComputedStyle(context.canvas).getPropertyValue('Width'));
        ...
        this.aspectRatio = this.width / this.height;console.log("_",width ,"--", this.width ,"--", context.canvas.width);
    ...
    extend(Chart.Type.prototype,{
        ...
        resize : function(callback){
			...
			console.log("on resize:  ",newWidth ,"--", this.chart.width ,"--", canvas.width);
