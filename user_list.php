...
<html>
  <head>
  <meta charset="UTF-8">
  <title><?php echo PROJECT_TITLE." | User List";?></title>
...
<div id="LegalModal_modal_edit_userList" tabindex="-1" aria-labelledby="myModalLabel" role="dialog"  aria-hidden="true" class="modal fade bs-example-modal-lg" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
      <div class="modal-content" id="edit_modal_userList"></div>
    </div>
  </div> 
...
$('#results').load("loadDataPagingUserList.php",{'pageNum':pageNum,'reg_id_user':reg_id},
function() {
                   $("#flash1").hide();
                   pageNum++;
...
function viewUserDetail(userid)    
{
      $("#LegalModal_viewUserDetail").modal();
       var info = 'action=viewUserDetail&userid='+userid; 
        $.ajax({
	    type: "POST",
