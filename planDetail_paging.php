...
foreach($que as $fetch)
{
    ...
    $plan_used_for1=$fetch['plan_used_for'];
    if($plan_used_for1=='p'){ $plan_used_for='Plan';  }
    if($plan_used_for1=='s'){ $plan_used_for='Subscription';  }
    if($plan_used_for1=='w'){ $plan_used_for='Web Series';  }
